...
“Flutter is **Google’s UI toolkit** for building **beautiful**, **natively compiled** applications for **mobile**, **web**, and **desktop** from a **single codebase**. (emphasis added)
...
Changes in UI can be applied instantly with Flutter’s hot reload. This is a big part of what makes building interfaces in Flutter so intuitive.
...
*I'm considering doing a write-up on the demo I originally planned to code live for the workshop at the YHack. For now, here's a [link](https://github.com/vinhowe/flutter-magic-8-ball) to the "ground truth" build I did a few weeks ago.*
